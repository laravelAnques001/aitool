            ...
            function delete_recodes() {
                        ...
                        function(isConfirm) {
                            if (isConfirm) {
                                $.ajax({
                                    ...
                                    swal({
                                        title: "Deleted!",
                                        text: "Tool has been successfully deleted..",
                                        type: "success",
                                        showCancelButton: true,
                                        closeOnConfirm: false,
                ...
                $(".switch").change(function() {
                    ...
                    $.ajax({
                        ...
                        if (data == 1) {
                            if (state == 1) {
                                toastr.success('Tool has been Activated', 'Activated');
                            } else {
                                toastr.error('Tool has been Deactivated', 'Deactivated');
                            }
                        } else {
                ...
                <div class="heading-elements">
                    <div class="heading-btn-group">
                        <a href="{{ route('tool.create') }}"
                            class="btn btn-labeled btn-labeled-right bg-blue heading-btn">Create Tool
                        </a>
                    </div>
                </div>
            </div>
