            ...
            <div class="page-header-content">
                <div class="page-title">
                    <h4>
                        ...
                        <span class="text-semibold">Generator Edit</span>
                    </h4>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-horizontal">
                        <div class="panel panel-flat">
                            ...
                            <form action="{{ route('generator.update', base64_encode($generator->id)) }}" method="POST"
                                            ...
                                            <select class="select" name="tool_id" id="tool_id">
                                                ...
                                                @foreach ($toolList as $tool)
                                                    <option value="{{ $tool->id }}"
                                                        {{ $generator->tool_id == $tool->id ? 'selected' : '' }}>
                                                        {{ $tool->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('tool_id')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="link" id="link"
                                                placeholder="Enter Generator Link"
                                                value="{{ old('link', $generator->link) }}">
                                            @error('link')
                                                <span class="error">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            @error('logo')
                                                <span class="error">{{ $message }}</span>
                                            @enderror
                                            <img src="{{ $generator->logo_url }}" alt="Generator Logo"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            ...
                                            @error('image')
                                                <span class="error">{{ $message }}</span>
                                            @enderror
                                            <img src="{{ $generator->image_url }}" alt="Generator Image"
                                                class="img-thumbnail" width="100" height="100">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <textarea rows="2" cols="5" class="form-control" id="description" name="description"
                                                placeholder="Enter Generator Description">{{ old('description', $generator->description) }}</textarea>
                                            @error('description')
                                                <span class="error">{{ $message }}</span>
                                            @enderror
                                        </div>
